...
<div id="app">
    <div class="main-wrapper container">
        ...
        <nav class="navbar navbar-expand-lg main-navbar">
            ...
            <!---->
            <!--				<ul class="navbar-nav">-->
            <!--					<li class="nav-item active"><a href="#" class="nav-link h3">Selamat datang</a></li>-->
            <!--				</ul>-->
            <!--			</div>-->
        </nav>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Klik Hurufnya ya ? :D</h4>
                                </div>
                                <div class="card-body">
                                    <!--                                    <div class="row mt-4">-->
                                    <div class="wizard-steps row">
										<?php foreach ( $hurufs as $huruf ): ?>
                                            <div class="col-12 col-lg-3">
                                                <a href="huruf.php?id=<?php echo $huruf->id ?>">
                                                    <div class="wizard-step wizard-step-active">
                                                        <!--                                                    <div class="wizard-step-icon">-->
                                                        <!--                                                        <i class="fas fa-tshirt"></i>-->
                                                        <!--                                                    </div>-->
                                                        <div class="wizard-step-label">
                                                            <h1 style="font-size: 1000%;" class="wizard-hover"><?php echo $huruf->nama_huruf ?></h1>
                                                        </div>
                                                    </div>
                                                </a>
                                            </div>
